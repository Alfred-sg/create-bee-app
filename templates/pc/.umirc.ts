...
const config: IConfig =  {
  ...
  publicPath: `publichPath/${DEPLOY_ENV}/`,
  treeShaking: true,
  ...
  routes: [
    {
      path: '/',
      component: meta.isAdmin ? '../layouts/AdminLayout' : '../layouts/BasicLayout',
      routes: [
        { path: '/403', component: '../pages/403' },
        { path: '/404', component: '../pages/404' },
        { path: '/500', component: '../pages/500' },
        meta.enableLogin ? { path: '/login', component: '../pages/login' } : undefined,
